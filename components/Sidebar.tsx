...
import { TodoItem, ScheduleItem, EventType } from '../types';
import { Plus, Trash2, Check, AlertTriangle, CloudDownload, CalendarCheck, Sparkles } from 'lucide-react';
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {activeTab === 'todos' ? (
          ...
          <div className="space-y-6">
            ...
            {/* USTC Sync */}
            <div>
              <h3 className="text-sm font-semibold text-gray-700 mb-2">External Data</h3>
              <button 
              ...
              >
                <CloudDownload size={16} /> Sync JW & Young (Mock)
              </button>
              <p className="text-[10px] text-gray-400 mt-1 leading-tight">
                Simulates fetching First & Second Classroom data (Requires internal network in prod).
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-400 mt-1">
                Uses Gemini AI to find free slots for study.
              </p>
            </div>
