...
import { BookOpen, ShieldCheck, Loader2, LogIn, UserPlus, Eye, EyeOff } from 'lucide-react';
          ...
          <div>
            ...
            <div className="relative">
                <input
                  ...
                  disabled={isLoading}
                  className="w-full px-4 py-2 bg-gray-50 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 outline-none transition text-sm disabled:opacity-50 pr-10"
                />
                <button
                  type="button"
